...
typedef unsigned int uint32;  // Asuming floats are 32 bits. 
typedef float float32;        // Asuming integers are 32 bits. 
...
#define FLOAT32_AS_UINT32(x) (...)  // Type-punning is performed.
...
\todo[inline=true, caption={high performance implemntations section}]{
\begin{enumerate}
\item How do the standard implementations work?
\item Why are they slow or in need of improvement?
\item Why will our approximations be faster (no conditional branching)?
\item Why will be the piecewise constant be fast?
\item How do I implement it?
\item Why will be the piecewise linear be fast?
\item How do I implement it. 
\item So how fast did they run (in Python or C, and on different hardware)?
\end{enumerate}
}
