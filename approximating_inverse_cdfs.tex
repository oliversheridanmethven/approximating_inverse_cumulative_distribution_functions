...
\subfigure[The $ L^2 $ error for various polynomial orders, with the number of intervals in $ (0, \tfrac{1}{2}) $ labeled.\label{fig:piecewise_linear_gaussian_approximation_error}]{\includegraphics{piecewise_linear_gaussian_approximation_error}}
