...
\label{tab:savings}
%\renewcommand{\arraystretch}{1.4}  % This is only local to this one table.
\begin{tabular}{lcclrcc}
Approximation  & $ {\log}_2 \left(\tfrac{\tilde{V}_l}{\hat{v}_l}\right) $ & $ \tfrac{\hat{c}_l}{\tilde{c}_l} $ & \multicolumn{2}{c}{Speed up} & $ \tfrac{\tilde{m}_l}{\hat{m}_l} $ & $ \tfrac{\tilde{m}_l}{\tilde{M}_l} $ \\[0.5em]
\hline
...
\todo{Throw together some C implementations and time it compared to GNU and Intel and compute some expected savings line in tables~\ref{tab:implementation_times} and \ref{tab:savings}.}
